...
@wget --no-check-certificate https://github.com/nogoth/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/nogoth/oh-my-zsh.git ~/.oh-my-zsh@
...
** Take a look at the "current themes":https://wiki.github.com/nogoth/oh-my-zsh/themes that come bundled with _Oh My Zsh_.
